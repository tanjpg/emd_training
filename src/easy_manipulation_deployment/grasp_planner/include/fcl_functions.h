#ifndef FCL_FUNCTIONS_H_
#define FCL_FUNCTIONS_H_
...
namespace FCLFunctions
{
  std::shared_ptr<fcl::CollisionObject<float>> createCollisionObjectFromPointCloudRGB(
    ...
    float resolution)
  //std::shared_ptr<octomap::OcTree> createOctomapFromPointCloud(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr pointcloud_ptr, const octomap::point3d& sensor_origin_wrt_world, float resolution)
  {
